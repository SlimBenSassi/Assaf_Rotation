...
[data_file_list, ndp] = uigetfile({'*.bdf','BDF file (*.bdf)' ;'*.*', 'All files (*.*)'},'Select raw file/s',raw_data_path,'multiselect','on');
if isscalar(data_file_list)
...
%my data reading code because of problems with read_biosemi_bdf
SDATA.data=EEGdata;
% log info
